...
export const api = {
  ...
  getPendingComments: () => request('/api/comments/pending'),
  ...
  banCommenter: (userId) => request(`/api/comments/users/${userId}/ban`, { method: 'POST' }),
  unbanCommenter: (userId) => request(`/api/comments/users/${userId}/unban`, { method: 'POST' }),
  ...
  setAssemblyZapisnicar: (id, userId) => request(`/api/assembly/sessions/${id}/zapisnicar`, { method: 'PUT', body: JSON.stringify({ userId }) }),
  ...
  updateAssemblyTopicMinutes: (id, text) => request(`/api/assembly/topics/${id}/minutes`, { method: 'PUT', body: JSON.stringify({ text }) }),
  ...
  getSiteNotice: () => request('/api/site-notice'),
  updateSiteNotice: (text) => request('/api/site-notice', { method: 'PUT', body: JSON.stringify({ text }) }),
