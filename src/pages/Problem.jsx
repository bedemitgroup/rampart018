...
export default function Problem() {
  ...
  const validate = () => {
    const errs = {};
    if (!form.anonymous && !form.name.trim()) errs.name = 'Ime je obavezno (ili označite "Šaljem anonimno")';
    if (!form.email.trim()) errs.email = 'Email adresa je obavezna';
    else if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(form.email)) errs.email = 'Unesite ispravnu email adresu';
    if (!form.category) errs.category = 'Izaberite kategoriju';
    if (!form.message.trim()) errs.message = 'Opis problema je obavezan';
    else if (form.message.trim().length < 30) errs.message = 'Molimo opišite problem detaljnije (min. 30 karaktera)';
    if (!form.consent) errs.consent = 'Morate prihvatiti uslove obrade podataka';
    return errs;
  };
    ...
    <>
      <section className="page-hero page-hero--accent">
        <div className="container page-hero__content">
          ...
          <h1 className="page-hero__title">Podeli problem sa nama</h1>
          ...
          <div className="problem-how">
            <div className="problem-how__step">
              ...
              <div>
                ...
                <p>Što detaljniji opis, to smo efikasniji. Možeš ostati anoniman.</p>
              </div>
            </div>
            ...
            <div className="problem-how__step">
              ...
              <div>
                ...
                <p>U roku od 48h procenjujemo prijavu i kontaktiramo te.</p>
              </div>
            </div>
            <div className="problem-how__arrow">→</div>
            <div className="problem-how__step">
              ...
              <div>
                ...
                <p>Pravna pomoć, posredovanje ili javna akcija — zavisno od slučaja.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container problem-section">
          <div className="problem-info">
            ...
            <div className="problem-info__card problem-info__card--highlight">
              <h3>📞 Hitna pomoć</h3>
              <p>Za urgentne situacije koje zahtevaju brzu reakciju, možeš nas pozvati direktno:</p>
              <a href="tel:+38121000000" className="problem-info__phone">+381 21 000 000</a>
              <p className="problem-info__hours">Pon–Pet, 9:00–17:00</p>
            </div>
          </div>
          ...
          <div className="problem-form-wrap">
            {submitted ? (
              <div className="problem-success">
                ...
                <h2 className="problem-success__title">Prijava primljena!</h2>
                <p className="problem-success__text">
                  Hvala ti što si se obratio/la udruženju Bedem.
                  Naš tim će pregledati tvoju prijavu i kontaktiraće te u roku od 48 sati
                  na email adresu koju si naveo/navela.
                </p>
                <p className="problem-success__ref">
                  Referentni broj: <strong>BDM-{Date.now().toString().slice(-6)}</strong>
                </p>
              ...
              <form className="problem-form" onSubmit={handleSubmit} noValidate>
                <div className="problem-form__header">
                  ...
                  <p>Sva polja označena sa <span className="required-star">*</span> su obavezna</p>
                </div>
                ...
                {!form.anonymous && (
                  <div className="form-group">
                    <label className="form-label" htmlFor="name">
                      Ime i prezime <span className="required-star">*</span>
                    </label>
                    <input
                      id="name"
                      name="name"
                ...
                <div className="problem-form__row">
                  <div className="form-group">
                    <label className="form-label" htmlFor="email">
                      Email adresa <span className="required-star">*</span>
                    </label>
                    <input
                      id="email"
                      name="email"
                ...
                <div className="problem-form__row">
                  <div className="form-group">
                    <label className="form-label" htmlFor="category">
                      Kategorija problema <span className="required-star">*</span>
                    </label>
                    <select
                      id="category"
                      name="category"
                  ...
                  <div className="form-group">
                    <label className="form-label" htmlFor="location">
                      Lokacija <span className="form-optional">(opciono)</span>
                    </label>
                    <input
                      id="location"
                      name="location"
                ...
                <div className="form-group">
                  <label className="form-label" htmlFor="message">
                    Opis problema <span className="required-star">*</span>
                  </label>
                  <textarea
                    id="message"
                    name="message"
                  ...
                  <div className="problem-form__counter">
                    {form.message.length} karaktera {form.message.length < 30 && form.message.length > 0 && `(potrebno još ${30 - form.message.length})`}
                  </div>
                ...
                <div className="form-group">
                  <label className={`problem-checkbox${errors.consent ? ' problem-checkbox--error' : ''}`}>
                    ...
                    <span className="problem-checkbox__box"></span>
                    <span>
                      Saglasan/na sam sa <a href="#" className="problem-form__link">politikom privatnosti</a> i
                      obradom ličnih podataka u svrhu postupanja po prijavi. <span className="required-star">*</span>
                    </span>
                  </label>
